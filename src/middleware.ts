...
const publicRoutes = ['/login', '/api/auth/login', '/api/sales/debug', '/api/calendar/orders', '/api/health', '/api/cron', '/api/debug', '/api/debug/sales-check', '/api/roster/migrate-barista', '/api/square/catalog-sync', '/api/admin', '/api/fix-rates', '/api/sms-test', '/api/roster/image'];
