...
const publicRoutes = ['/login', '/api/auth/login', '/api/barcode-lookup', '/api/sales/debug', '/api/sales/cross-sell-analysis', '/api/calendar/orders', '/api/health', '/api/cron', '/api/debug', '/api/debug/sales-check', '/api/debug/square-id-coverage', '/api/debug/square-ids', '/api/debug/square-order-fields', '/api/roster/migrate-barista', '/api/square/catalog-sync', '/api/admin', '/api/fix-rates', '/api/sms-test', '/api/roster/image', '/api/roster/list'];
